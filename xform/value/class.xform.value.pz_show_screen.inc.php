...
class rex_xform_value_pz_show_screen extends rex_xform_value_abstract
{
	...
	function enterObject()
	{
		...
		$field = '<input'.$classes.' id="'.$this->getFieldId().'" type="text" name="'.$this->getFieldName().'" value="'.htmlspecialchars(stripslashes($this->getElement(3))).'" DISABLED READONLY />';
		$extra = '';

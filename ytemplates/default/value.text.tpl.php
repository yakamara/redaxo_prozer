...
echo '
<div id="'.$this->getHTMLId().'" class="yform1 data yform-text">
...
/*
<div id="yform-yform-search-fulltext" class="yform1 data yform-text">
    <div class="flabel"><label for="yform-yform-field-1" class="yform-text">Allgemein</label></div>  <div class="felement"><input type="text" value="" name="search_fulltext" id="yform-yform-field-1" class="yform-text"></div>    </div>
*/

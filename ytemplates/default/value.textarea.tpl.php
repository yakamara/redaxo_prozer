...
echo '
   <div id="'.$this->getHTMLId().'" class="yform1 data yform-textarea formtextarea">
    <div class="flabel"><label for="'.$this->getFieldName().'" class="yform-textarea">'.$this->getLabel().'</label></div>
...
class="yform-textarea textarea '.$this->getElement(5) . ' ' . $this->getWarningClass().'">'.htmlspecialchars(stripslashes($this->getValue())).'</textarea></div>
   </div>';

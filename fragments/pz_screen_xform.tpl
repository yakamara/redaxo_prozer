...
if(!isset($this->class))
	$this->class = "";
$this->class = ($this->class == 'xform-checkbox') ? 'xform1-reverse '.$this->class : $this->class;
?>
...
?>
<?php echo $wrapper_s; ?>
<div class="xform1 data<?php echo ($this->class != '') ? ' '.$this->class : ''; ?>"<?php if(isset($this->html_id) && $this->html_id != "") echo ' id="'.$this->html_id.'"'; ?>>

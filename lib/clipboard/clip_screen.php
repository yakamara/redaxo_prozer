...
class pz_clip_screen
{
    ...
    public function getListView($p = [], $showInfo = false)
    {
        ...
        $delete_link = "pz_exec_javascript('".pz::url('screen', 'clipboard', 'get', array_merge($p['linkvars'], ['mode' => 'delete_clip']))."')";

        $classes = ['item','clip','clip-'.$this->clip->getId()];
        ...
        if ($this->clip->isReleased()) {
            $unrelease_link = "pz_exec_javascript('".pz::url('screen', 'clipboard', 'get', array_merge($p['linkvars'], ['mode' => 'unrelease_clip']))."')";
            ...
            $release_link_today    = "pz_exec_javascript('".pz::url('screen', 'clipboard', 'get', array_merge($p['linkvars'], ['mode' => 'release_clip', 'clip_release_duration' => 'today']))."')";
            $release_link_week     = "pz_exec_javascript('".pz::url('screen', 'clipboard', 'get', array_merge($p['linkvars'], ['mode' => 'release_clip', 'clip_release_duration' => 'week']))."')";
            $release_link_month    = "pz_exec_javascript('".pz::url('screen', 'clipboard', 'get', array_merge($p['linkvars'], ['mode' => 'release_clip', 'clip_release_duration' => 'month']))."')";
            $release_link_month_3  = "pz_exec_javascript('".pz::url('screen', 'clipboard', 'get', array_merge($p['linkvars'], ['mode' => 'release_clip', 'clip_release_duration' => '3month']))."')";
            ...
            $release_link = "pz_exec_javascript('".pz::url('screen', 'clipboard', 'get', array_merge($p['linkvars'], ['mode' => 'release_clip']))."')";

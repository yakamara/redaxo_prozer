    ...
    $orders['iddesc'] = array(
      ...
      "link"    => "javascript:pz_loadPage('addresses_list','" .
        pz::url(
          ...
          $p["controll"],
          $p["function"],
          array_merge($p["linkvars"], array( "mode" => "list", "search_orderby" => "iddesc" ))
        ) . "')"
    );
    $orders['idasc'] = array(
      "orderby" => "id",
      ...
      "link"    => "javascript:pz_loadPage('addresses_list','" .
        pz::url(
          ...
          $p["controll"],
          $p["function"],
          array_merge($p["linkvars"], array( "mode" => "list", "search_orderby" => "idasc" ))
        ) . "')"
    );

    //sort by NAME
    $orders['lastnamedesc'] = array(
      "orderby" => "name",
      "sort"    => "desc",
      ...
      "link"    => "javascript:pz_loadPage('addresses_list','" .
        pz::url(
          ...
          $p["controll"],
          $p["function"],
          array_merge($p["linkvars"], array( "mode" => "list", "search_orderby" => "lastnamedesc" ))
        ) . "')"
    );
    $orders['lastnameasc'] = array(
      "orderby" => "name",
      "sort"    => "asc",
      ...
      "link"    => "javascript:pz_loadPage('addresses_list','" .
        pz::url(
          ...
          $p["controll"],
          $p["function"],
          array_merge($p["linkvars"], array( "mode" => "list", "search_orderby" => "lastnameasc" ))
        ) . "')"
    );

    //sort by FIRSTNAME
    $orders['firstnamedesc'] = array(
      "orderby" => "firstname",
      "sort"    => "desc",
      ...
      "link"    => "javascript:pz_loadPage('addresses_list','" .
        pz::url(
          ...
          $p["controll"],
          $p["function"],
          array_merge($p["linkvars"], array( "mode" => "list", "search_orderby" => "firstnamedesc" ))
        ) . "')"
    );
    $orders['firstnameasc'] = array(
      "orderby" => "firstname",
      "asc"     => "asc",
      ...
      "link"    => "javascript:pz_loadPage('addresses_list','" .
        pz::url(
          ...
          $p["controll"],
          $p["function"],
          array_merge($p["linkvars"], array( "mode" => "list", "search_orderby" => "firstnameasc" ))
        ) . "')"
    );

    //sort COMPANY
    $orders['companydesc'] = array(
      "orderby" => "company",
      "sort"    => "desc",
      "name"    => pz_i18n::msg("address_orderby_companydesc"),
      "link"    => "javascript:pz_loadPage('addresses_list','" . pz::url($p["mediaview"], $p["controll"], $p["function"], array_merge($p["linkvars"], array( "mode" => "list", "search_orderby" => "companydesc" ))) . "')"
    );
    $orders['companyasc'] = array(
      "orderby" => "company",
      "sort"    => "asc",
      "name"    => pz_i18n::msg("address_orderby_companyasc"),
      "link"    => "javascript:pz_loadPage('addresses_list','" . pz::url($p["mediaview"], $p["controll"], $p["function"], array_merge($p["linkvars"], array( "mode" => "list", "search_orderby" => "companyasc" ))) . "')"
    );

...
class pz_admin_controller_api extends pz_admin_controller
{
    ...
    private function getCleanUpPage()
    {
        ...
        $filter = [];
        $filter[] = ['type' => '<', 'field' => 'created', 'value' => $date->format('Y-m-d 00:00')];
        $filter[] = ['type' => '=', 'field' => 'trash', 'value' => 1];
        ...
        $return[] = ['info' => $untrashed. ' emails untrashed'];
        $return[] = ['info' => $deleted.' emails deleted'];
        ...
        $filter = [];
        $filter[] = ['type' => '<', 'field' => 'stamp', 'value' => $date->format('Y-m-d 00:00')];
        ...
        $return[] = ['info' => $deleted.' logentries deleted'];
        $return[] = ['info' => 'cleanup finished'];

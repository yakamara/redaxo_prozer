...
class pz_sabre_carddav_backend extends Sabre_CardDAV_Backend_Abstract
{
  ...
  private function getGroup()
  {
    ...
    $card->rev = new Sabre_VObject_Element_DateTime('rev');
    $card->rev->setDateTime(new DateTime(null, new DateTimeZone('UTC')), Sabre_VObject_Element_DateTime::UTC);
    ...
    foreach($sql as $row)
    {
      $card->add(new Sabre_VObject_Property('X-ADDRESSBOOKSERVER-MEMBER', 'urn:uuid:'. str_replace('.vcf', '', $sql->getValue('uri'))));
    }
    return array(
      'uri' => self::GROUP .'.vcf',
      'lastmodified' => time(),
  ...
  private function getCardArray(pz_address $address)
  {
    ...
    $card->rev = new Sabre_VObject_Element_DateTime('rev');
    $card->rev->setDateTime(new DateTime($address->getVar('updated')), Sabre_VObject_Element_DateTime::UTC);
    unset($card->rev['value']);
  ...
  {
    $card = Sabre_VObject_Reader::read($cardData);
  ...
  static public function import($cardData)
  {
    $backend = new self;
  ...
  static public function export(pz_address $address)
  {
    $backend = new self;
  ...
  static public function incrementCtag()
  {

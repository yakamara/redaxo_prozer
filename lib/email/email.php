...
class pz_email extends pz_model
{
    ...
    */
    ...
    public static function getEmailsFromProjects($project_ids = [])
    {
        $p_sql = [];
    ...
    public static function countAll(array $filter = [], array $projects = [], array $users = [], array $orders = [], $pager = '')
    {
        $pager = new pz_pager();
    ...
    public static function getAll(array $filter = [], array $projects = [], array $users = [], array $orders = [], $pager = '')
    {
        $where = [];
        $params = [];
    ...
    public function getDateTime()
    {
        ...
        $dts = [DateTime::RFC822, DateTime::RFC1036, DateTime::RSS, DateTime::RFC850, DateTime::ISO8601, DateTime::RFC1123, DateTime::W3C, 'Y-m-d H:i:s'];

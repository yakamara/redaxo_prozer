...
class pz_pager_screen
{
    ...
    public function getPlainView($p = [], $content = '')
    {
        if ($this->pager->getRowCount() <= $this->pager->getRowsPerPage()) {
            return $content;
        }
        ...
        if ($next >= $this->pager->getRowCount()) {
            $next = '';
        }
    ...
    public function getScrollView($p = [], $content = '')
    {

...
class pz_history_screen 
{
  ...
  static public function getSearchForm ($p = array())
    ...
    $return = '
		...
		$xform->setValueField("pz_select_screen",array("search_modi",pz_i18n::msg("history_modi"),pz_history::getModi(),"","",0,pz_i18n::msg("please_choose")));
		$xform->setValueField("pz_select_screen",array("search_control",pz_i18n::msg("history_control"),pz_history::getControls(),"","",0,pz_i18n::msg("please_choose")));

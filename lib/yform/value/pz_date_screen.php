...
class rex_yform_value_pz_date_screen extends rex_yform_value_abstract
{
    public function enterObject()
    {
        ...
        $calendar = '<input id="'.$this->getHtmlId('date').'" class="yform-date" type="text" name="'.$this->getFieldName().'" value="'.$date.'"  />
        ...
        $name = $this->getName();
        $fragment_class = $class.' yform-date';

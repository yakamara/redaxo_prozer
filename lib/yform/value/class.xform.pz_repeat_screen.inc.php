...
class rex_yform_pz_repeat_screen extends rex_yform_abstract
{
    public function enterObject()
    {
        ...
        $field = $dropdown;
        // Auswahl = nach X Mal
        $field .= '<div id="'.$this->getFieldId().'-repeat-end-after" class="'.$this->getFieldId().'-repeat-end"><input type="number" value="" name="" max="10" min="1" class="yform-number" /><span class="fwording1">'.pz_i18n::translate('Mal').'</span></div>';
        // Auswahl = Datum
        ...
        $html_id = $this->getHTMLId();
        $name = $this->getName();
        $fragment_class = $class.' data-indent yform-number yform-date sl1-fnumber1-fwording1 sl1-fdate1-sl3';
        ...
        $field = '<input type="number" value="" name="" max="10" min="1" class="yform-number" /><span class="fwording1">'.pz_i18n::translate('Tag(e)').'</span>';
        $extra = '';
        $html_id = $this->getHTMLId();
        $name = $this->getName();
        $fragment_class = $class.' data-indent yform-number fnumber1-fwording1';

...
class rex_yform_pz_address_image_screen extends rex_yform_abstract
{
    public function enterObject()
    {
        ...
        $output = '	<div class="rex-form-row">
					...
					function replaceImage(clip_id){
						...
						if(clip_id) {
					    	link = "'.pz::url('screen', 'clipboard', 'get', ['mode' => 'image_src_raw', 'image_size' => 'xl', 'image_type' => 'image/jpg']).'"+"&clip_id="+clip_id;
					    	$.post(link, "", function(data) {
					    		if(data != "") {
					    			pz_hidden.val("PHOTO;ENCODING=b;TYPE=JPEG:"+data);

									link = "'.pz::url('screen', 'clipboard', 'get', ['mode' => 'image_inline', 'image_size' => 'm']).'"+"&clip_id="+clip_id;

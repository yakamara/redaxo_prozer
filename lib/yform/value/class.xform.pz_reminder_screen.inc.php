...
class rex_yform_pz_reminder_screen extends rex_yform_abstract
{
    public function enterObject()
    {
        ...
        $field = '<input type="number" value="" name="" min="1" class="yform-number" />';
        $field .= $popup_dropdown;
        $extra = '';
        $html_id = $this->getHTMLId();
        $name = $this->getName();
        $fragment_class = $class.' data-indent yform-number fnumber1-sl1';
        ...
        $html_id = $this->getHTMLId();
        $name = $this->getName();
        $fragment_class = $class.' data-indent yform-date sl1-fdate1-sl3';
